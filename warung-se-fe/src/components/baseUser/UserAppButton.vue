...
const variantClasses = computed(() => {
  switch (props.variant) {
    case 'secondary':
      // Menggunakan warna putih dengan border dan text merah (sesuai tema user)
      return 'bg-white border border-red-600 text-red-600 hover:bg-red-50'
    case 'outline-gray':
      return 'bg-transparent border border-gray-300 text-gray-600 hover:bg-gray-100'
    case 'google':
      return 'bg-[#4285F4] text-white hover:bg-[#3367D6] shadow-md hover:shadow-lg'
    default:
      // Default Primary menyesuaikan tema user: Merah (Red)
